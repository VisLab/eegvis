    ...
    methods (Access = protected)
        ...
        function createStatusPanel(obj, parent)
            ...
            obj.LoadOnSelectCB = uicontrol('Parent', statusGrid, ...
                ...
                'Load data into base workspace as an EEG structure');
    ...
    methods(Static = true)
        ...
        function pStruct = getDefaultPlots()
            ...
            pStruct = struct( ...
                ...
                'Category',       {'summary',      'summary',      'summary',     'summary',       'summary',       'detail',        'detail'}, ...
                'DisplayName',    {'Block image',  'Element box',  'Block box',   'Block histogram', 'Signal histogram', 'Stacked signal', 'Shadow signal'}, ...
                'Definition', { ...
