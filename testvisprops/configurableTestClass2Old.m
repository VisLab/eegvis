classdef configurableTestClass2Old < hgsetget & visprops.configurable
    ...
    methods
        function obj = configurableTestClass2Old()
            obj = obj@visprops.configurable();
            %obj.ConfigObj = visprops.ConfigurableObj([], [], obj);
            ...
            obj.PropSelect.putObject(class(obj), obj.ConfigObj);
            visprops.Property.updateProperties(obj.ConfigObj, obj.PropSelect.getManager());
    ...
    methods (Static = true)
        function settings = getDefaultProperties()
            ...
            % descriptions
            cName = 'visprops.propertyTestClass2';
            settings = struct( ...
                 'Enabled',  {true, true, true, true, true, true, true, true, true, true}, ...
                 'Category', {cName, cName, cName, cName, cName, cName, cName, cName, cName, cName}, ...
