    ...
    methods (Static=true)
        ...
        function fStruct = getDefaultFunctions()
            ...
            fStruct = struct( ...
                ...
                function fStruct = getOneEnabledFunction()
            % Structure specifying the default functions (one per tab)
            fStruct = struct( ...
                'Enabled',        {true,         false}, ...
                'Category',       {'block',        'block'}, ...
               ...
               function fStruct = getDefaultOneFunction()
            % Structure specifying the default functions (one per tab)
            fStruct = struct( ...
                'Enabled',        {true}, ...
                'Category',       {'block'}, ...
       ...
       function pStruct = getDefaultPlotsScalp()
            % Structure specifying the individual visualizations used
            pStruct = struct( ...
              ...
              function pStruct = getDefaultPlotsScalpShort()
            % Structure specifying the individual visualizations used
            pStruct = struct( ...
                'Enabled',        {true,           false,           false,          false,            true,          false,            false,           true}, ...
                'Category',       {'summary',      'summary',      'summary',     'summary',       'summary',       'summary',       'detail',        'detail'}, ...
                'DisplayName',    {'Block image',  'Element box',  'Block box',   'Block histogram', 'Block scalp', 'Signal histogram', 'Stacked signal', 'Shadow signal'}, ...
                'Definition', { ...
                'visviews.blockImagePlot', ...
       ...
       function pStruct = getDefaultPlotsSummaryOnly()
        ...
        function pStruct = getDefaultPlotsTwoShadowPlots()
            % Structure specifying the individual visualizations used
            pStruct = struct( ...
                'Enabled',        {true,           true,           true,          false,           true,           true}, ...
                'Category',       {'summary',      'summary',      'summary',     'summary',       'detail',        'detail'}, ...
                'DisplayName',    {'Block image',  'Element box',  'Block box',   'Block histogram' 'Shadow signal1', 'Shadow signal2'}, ...
                'Definition', { ...
                'visviews.blockImagePlot', ...
                'visviews.elementBoxPlot', ...
                'visviews.blockBoxPlot', ...
        ...
        end % getDefaultPlotsTwoShadowPlots
        
       function pStruct = getDefaultPlotsOneSummaryTwoDetails()
            % Structure specifying the individual visualizations used
            pStruct = struct( ...
                'Enabled',        {true,          true,           true}, ...
                'Category',       {'summary',     'detail',        'detail'}, ...
                'DisplayName',    {'Block box',   'Signal stacked', 'Signal shadow'}, ...
                'Definition', { ...
                'visviews.blockBoxPlot', ...
                'visviews.signalStackedPlot', ...
                'visviews.signalShadowPlot', ...
        ...
        end % getDefaultPlotsOneSummaryTwoDetails
        
       function pStruct = getDefaultPlotsWithEvents()
            % Structure specifying the individual visualizations used
            pStruct = struct( ...
