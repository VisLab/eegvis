...
values.hdf5Data = viscore.hdf5Data(EEG.data, 'EEG', eegFile, ...
    'SampleRate', EEG.srate);
...
testVD6 = viscore.memoryData(smallDataset, 'Rand1');
...
% Generate some data to plot
load('SingleElement.mat');
testVD7 = viscore.memoryData(singleElement, 'Rand1');
...
% Generate some data to plot
load('SmallDataset.mat');
smallDatasetFile = regexprep(which('EEG.mat'), 'EEG.mat$', 'SmallDataset.hdf5');
testVD6 = viscore.hdf5Data(smallDataset, 'Rand1', smallDatasetFile);
fig6 = figure('Name', 'Uneven  small group');
ip6 = visviews.blockImagePlot(fig6, [], []);
assertTrue(isvalid(ip6));
ip6.ClumpSize = 7;
...
% Generate some data to plot
load('SingleElement.mat');
singleElementFile = regexprep(which('EEG.mat'), 'EEG.mat$', 'SingleElement.hdf5');
testVD7 = viscore.hdf5Data(singleElement, 'Rand1', singleElementFile);
fig7 = figure('Name', 'One element grouped by 3');
ip7 = visviews.blockImagePlot(fig1, [], []);
assertTrue(isvalid(ip7));
ip7.ClumpSize = 3;
...
slice1 = viscore.dataSlice('Slices', {':', ':', '1:10'}, ...
    'DimNames', {'Channel', 'Sample', 'Window'});
ip1.plot(values.hdf5Data, values.fun, slice1);
gaps = ip1.getGaps();
ip1.reposition(gaps);
...
slice2 = viscore.dataSlice('Slices', {':', ':', '4:9'}, ...
    'DimNames', {'Channel', 'Sample', 'Window'});
ip2.plot(values.hdf5Data, values.fun, slice2);
gaps = ip2.getGaps();
ip2.reposition(gaps);
...
slice3 = viscore.dataSlice('Slices', {':', ':', '15:21'}, ...
    'DimNames', {'Channel', 'Sample', 'Window'});
ip3.plot(values.hdf5Data, values.fun, slice3);
gaps = ip3.getGaps();
ip3.reposition(gaps);
...
slice4 = viscore.dataSlice('Slices', {':', ':', '1:10'}, ...
    'DimNames', {'Channel', 'Sample', 'Window'});
ip4.ClumpSize = 2;
ip4.plot(values.hdf5Data, values.fun, slice4);
gaps = ip4.getGaps();
ip4.reposition(gaps);
...
slice5 = viscore.dataSlice('Slices', {':', ':', '14:20'}, ...
    'DimNames', {'Channel', 'Sample', 'Window'});
ip5.ClumpSize = 3;
ip5.plot(values.hdf5Data, values.fun, slice5);
gaps = ip5.getGaps();
ip5.reposition(gaps);
...
slice6 = viscore.dataSlice('Slices', {':', ':', '14:15'}, ...
    'DimNames', {'Channel', 'Sample', 'Window'});
ip6.ClumpSize = 3;
ip6.plot(values.hdf5Data, values.fun, slice6);
gaps = ip6.getGaps();
ip6.reposition(gaps);
...
slice7 = viscore.dataSlice('Slices', {'3', ':', '2'}, ...
    'DimNames', {'Channel', 'Sample', 'Window'});
ip7.plot(values.hdf5Data, values.fun, slice7);
gaps = ip7.getGaps();
ip7.reposition(gaps);
