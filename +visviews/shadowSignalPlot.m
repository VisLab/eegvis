...
classdef shadowSignalPlot < visviews.axesPanel  & visprops.configurable
    ...
    methods
        ...
        function obj = shadowSignalPlot(parent, manager, key)
            % Create a shadowSignalPlot
        ...
        end % shadowSignalPlot constructor
        ...
        function plot(obj, visData, bFunction, dSlice)
            ...
            elseif ~isempty(intersect(cDims, 1))  % Plot all windows for an element    
                ...
                warning('shadowSignalPlot:plotSlice', ...
...
%                       sample = floor(obj.VisData.SampleRate*t) + 1;
    ...
    methods (Access = private)
        ...
        function displayPlot(obj)
            ...
            set(obj.MainAxes, ...
                ...
                {@visviews.shadowSignalPlot.signalButtonDownFcn, obj}, ...
                'box', 'on', ...
    ...
    methods(Static=true)
        ...
        function settings = getDefaultProperties()
            ...
            cName = 'visviews.shadowSignalPlot';
            settings = struct( ...
