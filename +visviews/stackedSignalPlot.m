% visviews.stackedSignalPlot()  display stacked view of individual element or window signals
%
% Usage:
...
%   sp = visviews.stackedSignalPlot(sfig3, [], []);
%   sp.SignalScale = 2.0;
...
% $Log: stackedSignalPlot.m,v $
% Revision: 1.00  04-Dec-2011 09:11:20  krobbins $
% Initial version $
%

classdef stackedSignalPlot < visviews.axesPanel  & visprops.configurable 
    ...
    methods
        ...
        function obj = stackedSignalPlot(parent, manager, key)
        ...
        end % stackedSignalPlot constructor
        ...
        function plot(obj, visData, bFunction, dSlice)
            ...
            elseif ~isempty(intersect(cDims, 1))  % Plot all windows for an element 
                ...
                warning('stackedSignalPlot:plotSlice', ...
    ...
    methods(Static=true)
        ...
        function settings = getDefaultProperties()
            ...
            cName = 'visviews.stackedSignalPlot';
            settings = struct( ...
